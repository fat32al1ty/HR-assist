...
Сейчас в работе — **Phase 1.7**: поднимаем качество подбора (минимальный overlap по скиллам, штраф за несовпадение грейда, time-decay предпочтений) и добавляем поддержку до 2 параллельных профилей-резюме у одного пользователя с изолированными лайками/дизлайками.

Недавние релизы:

- `v1.0.0` — Phase 1 (Actionability): предпочтения при поиске, объяснение совпадений, трекер откликов, AI-сопроводительные, отмена подбора.
