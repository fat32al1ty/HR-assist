...
Сейчас готовимся к **Phase 2** (Retention): дайджесты и проактивные уведомления по новым подходящим вакансиям. Релевантность подбора, мульти-профиль и доменный фильтр уже в проде — см. релиз `v0.4.0`.
