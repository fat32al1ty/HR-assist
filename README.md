...
Сейчас готовимся к **Phase 2** (Retention): дайджесты и проактивные уведомления по новым подходящим вакансиям. Свежесть, точность и user-agency над «не хватает» уже в проде — см. релиз `v0.5.0`.
