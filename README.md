...
Сейчас завершена **Phase 2.8 — Serious product polish** (`v0.8.0`): продукт ощутимо подтянули по UX, дизайну и правде ошибок. Следом возвращаемся к **Phase 2 — Retention**: дайджесты и проактивные уведомления по новым подходящим вакансиям.
