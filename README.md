...
Сейчас готовимся к **Phase 2** (Retention): дайджесты и проактивные уведомления по новым подходящим вакансиям. First-run UX, two-tier output и one-button подбор уже в проде — см. релиз `v0.6.0`.
