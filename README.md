...
Сейчас готовимся к **Phase 2 — Retention**: дайджесты и проактивные уведомления по новым подходящим вакансиям. Качественный апгрейд матчера (`v0.7.0`) и first-run UX (`v0.6.0`) уже в проде.
