...
Следующие 3 релиза — `v0.13.0` (track segmentation), `v0.14.0` (per-vacancy strategy + cover letter), `v1.0.0` (domain expansion, **PMF-gated**). Полный план и принципы — в [`.claude/skills/product-roadmap/SKILL.md`](../.claude/skills/product-roadmap/SKILL.md).
