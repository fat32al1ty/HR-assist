            ...
            <div className="flex flex-col gap-7 animate-fade-in">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-[length:var(--text-lg)] leading-[var(--leading-relaxed)] text-[color:var(--color-ink-secondary)] max-w-[560px]">
                  Резюме на входе — на выходе аудит под рынок, ранжированные
                  вакансии и стратегия отклика на каждую.
                </p>
              </div>

              <ul className="grid gap-3 max-w-[560px]">
                {[
                  ['Аудит резюме под рынок', 'Роль, грейд, зарплатный коридор и топ-5 навыков, которых тебе не хватает по живым вакансиям.'],
                  ['Вакансии в 3 трека сложности', '«Точка», «вырост» и «стрейч» — видно, где совпадаешь полностью, а где нужно добрать.'],
                  ['Стратегия на каждую вакансию', 'AI объясняет, что в опыте релевантно и чего не хватает. Сопроводительное — рядом, по кнопке.'],
                  ['Два резюме — две карьеры', 'Специалист и руководитель в одной воронке откликов. Не перемешиваются.'],
                ].map(([title, body]) => (
